...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_id",
        type=str,
        help="None or int of a pretrained model, will change dataset",
        default="None",
    )
    parser.add_argument("--epochs", type=int, help="int, number of epochs", default=10)
    ...
    if not os.path.exists(data_utils.training_data_path) or not np.any(
        [dataset in x for x in os.listdir(data_utils.training_data_path)]
    ):
